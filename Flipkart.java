class Flipkart
{
	public boolean login(String username,String psw)
	{
		...
		String regusername="Yogesh456";
		String regpsw="Yogesh@456";
	...
	public String login(String emailId,String psw,String captcha)
	{
		...
		String msg=null;
		String regemailId="Yogesh456@gmail.com";
		String regpsw="Yogesh@mail456";
	...
	public String searchProduct(String productName,double rating,String category)
	{
		System.out.println("searching product by product name : " +productName+  " and product rating : " +rating+  " and product category : " +category);
		String msg=null;
		if(productName!=null && rating!=0.0 && category!=null)
		{
